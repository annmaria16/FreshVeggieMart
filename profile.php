...
<body>
    <section>
        ...
        <div class="profile-container">
            ...
            <form action="" method="POST" class="profile-form" onsubmit="return validateForm()">
    ...
    <script>
        ...
        function validateForm() {
            ...
            if (!userId || !email || !phone || !address || !city) {
                alert('Please fill in all required fields.');
                return false;
            }

            if (!/^[a-zA-Z\s]+$/.test(userId)) {
                alert('User ID must contain only letters and spaces.');
                return false;
            }
